...
from check_mk_agent.openstack.common.py3kcompat import urlutils
from check_mk_agent.openstack.common import test
...
def _set_db_lock(lock_path=None, lock_prefix=None):
    def decorator(f):
        ...
        def wrapper(*args, **kwargs):
            try:
                path = lock_path or os.environ.get("CHECK_MK_AGENT_LOCK_PATH")
