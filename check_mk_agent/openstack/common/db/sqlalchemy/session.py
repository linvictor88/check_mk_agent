...
* Call set_defaults with the minimal of the following kwargs:
  ...
  Example::
    ...
    session.set_defaults(
        sql_connection="sqlite:///var/lib/check_mk_agent/sqlite.db",
        sqlite_db="/var/lib/check_mk_agent/sqlite.db")
...
from check_mk_agent.openstack.common.db import exception
from check_mk_agent.openstack.common.gettextutils import _
from check_mk_agent.openstack.common import log as logging
from check_mk_agent.openstack.common import timeutils

sqlite_db_opts = [
    cfg.StrOpt('sqlite_db',
               default='check_mk_agent.sqlite',
    ...
    def _do_query(self, q):
        ...
        for filename, line, method, function in traceback.extract_stack():
            ...
            if filename.endswith('db/api.py'):
                continue
            # only trace inside check_mk_agent
            index = filename.rfind('check_mk_agent')
            if index == -1:
                continue
